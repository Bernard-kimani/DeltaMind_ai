...
Pure Python — computes Greeks, IV percentile, and portfolio risk metrics from
`state["market_data"]` / `state["option_chain"]`. Deliberately has no LLM
dependency: this node's output must be reproducible and auditable by judges.
"""
